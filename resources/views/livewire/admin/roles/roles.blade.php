                                ...
                                <table class="table color-bordered-table info-table  info-bordered-table">
                                    ...
                                    @foreach($roles as  $key => $role)
                                        <tr>
                                            ...
                                            <td>{{$role->name}}</td>
                                            <td><a class="text-bold" href="{{route('admin.users',['role_id' => $role->id])}}">{{$role->users()->count()}}</a></td>
                                            <td><span class="badge badge-success">{!!  $role->name == "Admin" ? __("All permissions") : $role->permissions()->pluck('name')->implode('</span> <span class="badge badge-success"> ') !!}</span></td>
                                            <td>
