        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a class="btn btn-primary float-end"  data-bs-toggle="modal" data-bs-target="#CreateUser" wire:click.prevent="CreateUser" data-bs-original-title="" title=""> {{__('Create User')}}</a>
                    </div>
                    @endif
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                    ...
                    @if($create_user)
                    @livewire('admin.users.users-create',[$user_id])
                    @endif
                </div>
            </div>
        </div>
