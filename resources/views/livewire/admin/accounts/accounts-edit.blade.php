<form class="mt-2" method="post" wire:submit.prevent="update" autocomplete="off">
    {{csrf_field()}}
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if($account['is_trial'] === false)
                            <select wire:model="account.duration" class="form-control @error('account.bouquet') is-invalid @enderror">
